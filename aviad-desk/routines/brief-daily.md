...
**למה זה כאן וגם ב-gateway:** gateway מריץ את השומר כל שעתיים, אבל הוא לא יכול לדווח על
...
**אתה לא שולח בעצמך.** אתה מתייק לתור היוצא, ו-gateway שולח בירייה הקרובה (03:36 UTC):
...
ומגיע לטלפון ב-03:36 UTC (06:36 שעון ישראל). הפורמט, בדיוק, עם כותרות האימוג'י:
